...
void MainWindow::setSettingStruct()
{
    ...
    settingArr[0].trigDelay             = 160;//176
    ...
    settingArr[0].filtPar[2].gain        = 25;//25
    ...
    settingArr[1].trigDelay             = 240;//264
    ...
    settingArr[5].samplingFreq          = 20; //20
    settingArr[5].chNum                 = 1;
    settingArr[5].trigDelay             = 160;
    settingArr[5].daqVoltage            = 200;
    ...
    settingArr[6].trigDelay             = 320;  // initial : 576,
    settingArr[6].daqVoltage            = 200;
    ...
    settingArr[7].trigDelay             = 320;
    settingArr[7].daqVoltage            = 1000;
    ...
    settingArr[8].trigDelay             = 80; //536
    settingArr[8].daqVoltage            = 200;
...
void MainWindow::deviceConnect()
{
    ...
    laser->srchPortandConnect("COM8",&laserComPort);
    ldv->connectLdv("COM5");
